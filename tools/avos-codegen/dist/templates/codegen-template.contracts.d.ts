...
export declare enum CodeGenTemplateType {
    FILE = "file",
    DIRECTORY = "directory",
    PARTIAL = "partial",
    FRAGMENT = "fragment",
...
export declare enum CodeGenTemplateStatus {
    DRAFT = "draft",
    ACTIVE = "active",
    DISABLED = "disabled",
    ARCHIVED = "archived"
}
export declare enum CodeGenTemplateSourceType {
    INLINE = "inline",
...
//# sourceMappingURL=codegen-template.contracts.d.ts.map