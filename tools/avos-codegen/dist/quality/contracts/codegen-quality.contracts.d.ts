...
export declare enum CodeGenQualitySeverity {
    INFORMATIONAL = "informational",
    WARNING = "warning",
    ERROR = "error",
    CRITICAL = "critical"
}
export declare enum CodeGenQualityRuleCategory {
    STRUCTURE = "structure",
    NAMING = "naming",
    IMPORTS = "imports",
    NESTJS = "nestjs",
...
export interface CodeGenQualityRule {
    ...
    validate(context: CodeGenQualityRuleContext): Promise<CodeGenQualityRuleResult> | CodeGenQualityRuleResult;
}
...
//# sourceMappingURL=codegen-quality.contracts.d.ts.map