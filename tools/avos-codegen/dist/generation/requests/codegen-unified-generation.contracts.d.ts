...
import { CodeGenConflictPolicy, CodeGenGenerationReport, CodeGenOutputManifest } from "../../output/codegen-output.contracts";
export declare enum CodeGenUnifiedGenerationMode {
    BLUEPRINT = "blueprint",
    GENERATOR = "generator",
    TEMPLATE = "template"
}
...
//# sourceMappingURL=codegen-unified-generation.contracts.d.ts.map