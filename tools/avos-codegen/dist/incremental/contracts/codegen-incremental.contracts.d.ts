...
export declare enum CodeGenArtifactChangeType {
    CREATED = "created",
    MODIFIED = "modified",
    UNCHANGED = "unchanged",
    DELETED = "deleted",
...
export declare enum CodeGenRegenerationDecision {
    GENERATE = "generate",
...
export declare enum CodeGenIncrementalRunStatus {
    CREATED = "created",
    DETECTING = "detecting",
    PLANNING = "planning",
    EXECUTING = "executing",
...
//# sourceMappingURL=codegen-incremental.contracts.d.ts.map