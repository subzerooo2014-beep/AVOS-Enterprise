...
export declare enum CodeGenValidationSeverity {
    INFORMATIONAL = "informational",
    WARNING = "warning",
    ERROR = "error",
    CRITICAL = "critical"
}
export declare enum CodeGenValidationCategory {
    BLUEPRINT = "blueprint",
    TEMPLATE = "template",
    VARIABLES = "variables",
...
export interface CodeGenValidationRule {
    ...
    validate(context: CodeGenValidationContext): Promise<CodeGenValidationRuleResult> | CodeGenValidationRuleResult;
}
...
//# sourceMappingURL=codegen-validation.contracts.d.ts.map