...
exports.CodeGenGeneratorV3ModuleRenderer = void 0;
...
class CodeGenGeneratorV3ModuleRenderer {
    artifacts;
    ...
    render(context) {
        ...
        if (request.includeController) {
            moduleImports.push(`import { ${names.pascalModule}Controller } from "./${names.kebabModule}.controller";`);
            controllers.push(`${names.pascalModule}Controller`);
        }
        if (request.includeService) {
            moduleImports.push(`import { ${names.pascalModule}Service } from "./${names.kebabModule}.service";`);
            providers.push(`${names.pascalModule}Service`);
            exportsList.push(`${names.pascalModule}Service`);
        }
...
`;
        results.push(this.artifacts.create({
            id: `${names.kebabModule}:module`,
            key: `${names.kebabModule}.module`,
            type: codegen_artifact_contracts_1.CodeGenArtifactType.SOURCE,
            relativePath: `${basePath}/${names.kebabModule}.module.ts`,
...
`;
            results.push(this.artifacts.create({
                id: `${names.kebabModule}:service`,
                key: `${names.kebabModule}.service`,
                type: codegen_artifact_contracts_1.CodeGenArtifactType.SOURCE,
                relativePath: `${basePath}/${names.kebabModule}.service.ts`,
        ...
        if (request.includeController) {
            const dtoImport = request.includeDtos
...
import { Update${names.pascalEntity}Dto } from "./dto/update-${names.kebabEntity}.dto";`
                : "";
            const createType = request.includeDtos
                ? `Create${names.pascalEntity}Dto`
                : "Record<string, unknown>";
            const updateType = request.includeDtos
...
`;
            results.push(this.artifacts.create({
                id: `${names.kebabModule}:controller`,
                key: `${names.kebabModule}.controller`,
                type: codegen_artifact_contracts_1.CodeGenArtifactType.SOURCE,
                relativePath: `${basePath}/${names.kebabModule}.controller.ts`,
...
exports.CodeGenGeneratorV3ModuleRenderer = CodeGenGeneratorV3ModuleRenderer;
//# sourceMappingURL=codegen-generator-v3-module-renderer.js.map