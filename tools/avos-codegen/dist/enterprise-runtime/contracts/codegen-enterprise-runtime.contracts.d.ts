...
export declare enum CodeGenEnterpriseSessionStatus {
    CREATED = "created",
...
export declare enum CodeGenEnterpriseSessionMode {
    PREVIEW = "preview",
    GENERATE = "generate",
...
//# sourceMappingURL=codegen-enterprise-runtime.contracts.d.ts.map