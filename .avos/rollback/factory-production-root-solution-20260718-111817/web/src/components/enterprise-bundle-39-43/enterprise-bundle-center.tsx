...
import {
  enterpriseBundleCenters,
  type EnterpriseCenterKey,
} from "@/data/enterprise-bundle-39-43";
import styles from "./enterprise-bundle-center.module.css";

type Props = {
  center: EnterpriseCenterKey;
};
    ...
    <main className={styles.page}>
      ...
      <section className={styles.controls}>
        <input
          ...
          placeholder="ابحث في البيانات والتوصيات"
        />
        <select
          value={status}
      ...
      <section className={styles.workspace}>
        <div className={styles.listPanel}>
          <div className={styles.heading}>
            <div>
              <span>ENTERPRISE INTELLIGENCE MATRIX</span>
            ...
            {visibleRecords.map((record) => (
              <button
                ...
                className={`${styles.recordCard} ${
                  selected?.id === record.id ? styles.selected : ""
                }`}
              >
                <div className={styles.cardTop}>
                  <span>{record.id}</span>
                  <span className={styles[record.status]}>
          ...
          {selected && (
            <>
              ...
              <div className={styles.aiBox}>
                <span>AVOS ENTERPRISE INTELLIGENCE</span>
