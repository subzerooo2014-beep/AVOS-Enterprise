...
const data = fs.readFileSync(
  path.join(root, "src/data/enterprise-bundle-29-33.ts"),
  "utf8",
);
...
process.stdout.write(JSON.stringify({
  ...
  centers: 5,
  records,
  financeCockpitReady: true,
  strategyCenterReady: true,
  aiGrowthCenterReady: true,
  globalOperationsReady: true,
