export default function CustomerAppPage() {
  return (
    <main className="mx-auto max-w-6xl px-6 py-10">
      ...
      <h1 className="mt-4 text-3xl font-bold">Customer App</h1>
      <p className="mt-3 max-w-3xl text-neutral-600">Marketplace, offers, bookings, messages, and ownership journey.</p>
