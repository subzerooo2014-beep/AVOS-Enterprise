...
$TargetModule = Join-Path $ApiSrc "avos-factory-mega-pack-3"
$BackupModule = Join-Path $RollbackRoot "avos-factory-mega-pack-3"
...
Write-Host "AVOS Factory Mega Pack 3 rollback completed." -ForegroundColor Green
