export default function InsurancePartnerAppPage() {
  return (
    <main className="mx-auto max-w-6xl px-6 py-10">
      <a href="/applications" className="text-sm text-neutral-500">
        Back to Applications Suite
      </a>
      <h1 className="mt-4 text-3xl font-bold">Insurance Partner App</h1>
      <p className="mt-3 max-w-3xl text-neutral-600">Quotes, policies, claims, and renewals.</p>
