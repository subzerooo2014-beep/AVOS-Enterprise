export type ResilienceProfileStatus = "draft" | "active" | "suspended" | "retired";
export type RecoveryPlanStatus = "draft" | "approved" | "active" | "paused" | "retired";
export type RecoveryExecutionStatus = "queued" | "running" | "completed" | "partially_completed" | "failed" | "cancelled";
export type ExerciseStatus = "planned" | "running" | "passed" | "failed" | "cancelled";
export type DependencyHealthStatus = "healthy" | "degraded" | "unavailable" | "unknown";
export type CheckpointStatus = "created" | "verified" | "restored" | "invalid";
export type RecoveryDecision = "no_action" | "monitor" | "degrade_service" | "restart_component" | "failover" | "restore_checkpoint" | "isolate_dependency" | "escalate";
...
export interface FailureSimulation {
    ...
    profileId: string;
    name: string;
    failureType: "latency" | "dependency_failure" | "resource_exhaustion" | "service_unavailable" | "data_corruption";
    target: string;
