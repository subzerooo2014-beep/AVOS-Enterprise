...
let OrganizationsRepository = class OrganizationsRepository extends base_repository_1.BaseRepository {
    constructor(prisma) {
        super(prisma);
    }
    list(page = 1, limit = 20, where = {}) {
        return super.paginate(this.prisma["organization"], { where }, page, limit);
    }
};
