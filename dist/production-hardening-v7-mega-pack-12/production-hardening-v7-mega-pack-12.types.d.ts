export type SloStatus = "draft" | "active" | "breached" | "suspended" | "retired";
export type ErrorBudgetStatus = "healthy" | "warning" | "exhausted";
export type CapacityRisk = "low" | "medium" | "high" | "critical";
export type TrafficPolicyStatus = "draft" | "active" | "triggered" | "disabled";
export type TrafficProtectionAction = "none" | "monitor" | "throttle" | "shed_load" | "queue_requests" | "disable_noncritical_features" | "block_deployments" | "scale_out";
