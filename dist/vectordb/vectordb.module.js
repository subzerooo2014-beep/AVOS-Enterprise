...
const vectordb_controller_1 = require("./vectordb.controller");
...
exports.VectordbModule = VectordbModule = __decorate([
    (0, common_1.Module)({
        controllers: [vectordb_controller_1.VectordbController],
        providers: [vectordb_service_1.VectordbService],
    })
], VectordbModule);
