...
export type ConfigurationValue = string | number | boolean | null | Record<string, unknown> | unknown[];
export type ConfigurationStatus = "draft" | "pending_approval" | "active" | "rejected" | "rolled_back" | "disabled";
export type ApprovalDecision = "approved" | "rejected";
export type PolicySeverity = "low" | "medium" | "high" | "critical";
export type PolicyEvaluationResult = "passed" | "warning" | "blocked";
export type DriftStatus = "compliant" | "drifted" | "critical_drift";
export type FeatureFlagStrategy = "all" | "percentage" | "environment" | "service" | "manual";
export type KillSwitchStatus = "armed" | "activated" | "released";
