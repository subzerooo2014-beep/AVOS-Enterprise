...
@Injectable()
export class PublisherAdvancedAnalyticsService {
  constructor(
  ...
  async kpis(input?: {
    ...
    return {
      ...
      kpis: {
        totalPublications:
          this.kpi(
            metrics.overview.totalPublications,
            previousMetrics.overview.totalPublications,
          ),

        delivered:
          this.kpi(
            metrics.overview.delivered,
            previousMetrics.overview.delivered,
          ),

        failed:
          this.kpi(
            metrics.overview.failed,
            previousMetrics.overview.failed,
          ),

        successRate:
          this.kpi(
            metrics.overview.successRate,
            previousMetrics.overview.successRate,
          ),

        averageDeliveryDurationMs:
          this.kpi(
            metrics.overview.averageDeliveryDurationMs,
            previousMetrics.overview.averageDeliveryDurationMs,
            true,
          ),

        averageAttempts:
          this.kpi(
            metrics.overview.averageAttempts,
            previousMetrics.overview.averageAttempts,
            true,
          ),

        receiptCoverageRate:
          this.kpi(
            metrics.overview.receiptCoverageRate,
            previousMetrics.overview.receiptCoverageRate,
          ),

        versionedPublicationRate:
          this.kpi(
            metrics.overview.versionedPublicationRate,
            previousMetrics.overview.versionedPublicationRate,
          ),
      },
