...
import { MetadataSchemaRecord } from "./schema.types";

@Controller("enterprise-metadata-layer/schema")
export class MetadataSchemaController {
  constructor(private readonly service: MetadataSchemaService) {}
  ...
  @Post("records") create(@Body() body: Pick<MetadataSchemaRecord, "name" | "description"> & Partial<Pick<MetadataSchemaRecord, "score" | "metadata">>) { return this.service.create(body); }
