...
import { DigitalDnaMetricsRecord } from "./metrics.types";

@Controller("digital-dna/metrics")
export class DigitalDnaMetricsController {
  constructor(private readonly service: DigitalDnaMetricsService) {}
  ...
  create(
    @Body()
    body: Pick<DigitalDnaMetricsRecord, "assetType" | "assetId" | "name" | "purpose" | "owner"> &
      Partial<
        Pick<
