...
import { DigitalDnaEventsRecord } from "./events.types";

@Controller("digital-dna/events")
export class DigitalDnaEventsController {
  constructor(private readonly service: DigitalDnaEventsService) {}
  ...
  create(
    @Body()
    body: Pick<DigitalDnaEventsRecord, "assetType" | "assetId" | "name" | "purpose" | "owner"> &
      Partial<
        Pick<
