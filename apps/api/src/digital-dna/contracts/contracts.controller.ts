...
import { DigitalDnaContractsRecord } from "./contracts.types";

@Controller("digital-dna/contracts")
export class DigitalDnaContractsController {
  constructor(private readonly service: DigitalDnaContractsService) {}
  ...
  create(
    @Body()
    body: Pick<DigitalDnaContractsRecord, "assetType" | "assetId" | "name" | "purpose" | "owner"> &
      Partial<
        Pick<
