...
@Controller("media-entertainment-industry")
export class MediaEntertainmentIndustryController {
  ...
  createRecord(
    ...
    return this.industry.createRecord("MEDIA_ENTERTAINMENT", capability, input);
  }
  ...
  listRecords(
    ...
    return this.industry.listRecords("MEDIA_ENTERTAINMENT", capability, tenantId);
  }
  ...
  @Get("command-center")
  commandCenter() {
    return this.industry.commandCenter("MEDIA_ENTERTAINMENT");
  }
}