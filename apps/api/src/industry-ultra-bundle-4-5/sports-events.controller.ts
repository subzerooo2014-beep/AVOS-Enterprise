...
@Controller("sports-events-industry")
export class SportsEventsIndustryController {
  ...
  createRecord(
    ...
    return this.industry.createRecord("SPORTS_EVENTS", capability, input);
  }
  ...
  listRecords(
    ...
    return this.industry.listRecords("SPORTS_EVENTS", capability, tenantId);
  }
  ...
  @Get("command-center")
  commandCenter() {
    return this.industry.commandCenter("SPORTS_EVENTS");
  }
}