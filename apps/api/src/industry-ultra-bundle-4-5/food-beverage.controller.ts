...
@Controller("food-beverage-industry")
export class FoodBeverageIndustryController {
  ...
  createRecord(
    ...
    return this.industry.createRecord("FOOD_BEVERAGE", capability, input);
  }
  ...
  listRecords(
    ...
    return this.industry.listRecords("FOOD_BEVERAGE", capability, tenantId);
  }
  ...
  @Get("command-center")
  commandCenter() {
    return this.industry.commandCenter("FOOD_BEVERAGE");
  }
}