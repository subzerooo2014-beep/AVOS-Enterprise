...
@Controller("environment-waste-industry")
export class EnvironmentWasteIndustryController {
  ...
  createRecord(
    ...
    return this.industry.createRecord("ENVIRONMENT_WASTE", capability, input);
  }
  ...
  listRecords(
    ...
    return this.industry.listRecords("ENVIRONMENT_WASTE", capability, tenantId);
  }
  ...
  @Get("command-center")
  commandCenter() {
    return this.industry.commandCenter("ENVIRONMENT_WASTE");
  }
}