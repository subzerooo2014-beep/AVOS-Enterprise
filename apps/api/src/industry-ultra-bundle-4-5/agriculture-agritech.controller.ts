...
@Controller("agriculture-agritech-industry")
export class AgricultureAgritechIndustryController {
  ...
  createRecord(
    ...
    return this.industry.createRecord("AGRICULTURE_AGRITECH", capability, input);
  }
  ...
  listRecords(
    ...
    return this.industry.listRecords("AGRICULTURE_AGRITECH", capability, tenantId);
  }
  ...
  @Get("command-center")
  commandCenter() {
    return this.industry.commandCenter("AGRICULTURE_AGRITECH");
  }
}