...
@Controller("space-satellite-industry")
export class SpaceSatelliteIndustryController {
  ...
  createRecord(
    ...
    return this.industry.createRecord("SPACE_SATELLITE", capability, input);
  }
  ...
  listRecords(
    ...
    return this.industry.listRecords("SPACE_SATELLITE", capability, tenantId);
  }
  ...
  @Get("command-center")
  commandCenter() {
    return this.industry.commandCenter("SPACE_SATELLITE");
  }
}