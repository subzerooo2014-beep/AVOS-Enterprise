...
@Controller("security-emergency-services-industry")
export class SecurityEmergencyServicesIndustryController {
  ...
  createRecord(
    ...
    return this.industry.createRecord("SECURITY_EMERGENCY_SERVICES", capability, input);
  }
  ...
  listRecords(
    ...
    return this.industry.listRecords("SECURITY_EMERGENCY_SERVICES", capability, tenantId);
  }
  ...
  @Get("command-center")
  commandCenter() {
    return this.industry.commandCenter("SECURITY_EMERGENCY_SERVICES");
  }
}