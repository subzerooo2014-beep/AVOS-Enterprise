...
@Controller("legal-professional-services-industry")
export class LegalProfessionalServicesIndustryController {
  ...
  createRecord(
    ...
    return this.industry.createRecord("LEGAL_PROFESSIONAL_SERVICES", capability, input);
  }
  ...
  listRecords(
    ...
    return this.industry.listRecords("LEGAL_PROFESSIONAL_SERVICES", capability, tenantId);
  }
  ...
  @Get("command-center")
  commandCenter() {
    return this.industry.commandCenter("LEGAL_PROFESSIONAL_SERVICES");
  }
}