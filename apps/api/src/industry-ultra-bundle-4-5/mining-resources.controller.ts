...
@Controller("mining-resources-industry")
export class MiningResourcesIndustryController {
  ...
  createRecord(
    ...
    return this.industry.createRecord("MINING_RESOURCES", capability, input);
  }
  ...
  listRecords(
    ...
    return this.industry.listRecords("MINING_RESOURCES", capability, tenantId);
  }
  ...
  @Get("command-center")
  commandCenter() {
    return this.industry.commandCenter("MINING_RESOURCES");
  }
}