...
import { CapabilityMarketplaceCapability } from './capability-marketplace.types';

@Injectable()
export class CapabilityMarketplaceService {
  private readonly capability: CapabilityMarketplaceCapability = {
  ...
  getStatus(): CapabilityMarketplaceCapability {
    return {
      ...this.capability,
