...
import { BlueprintMarketplaceCapability } from './blueprint-marketplace.types';

@Injectable()
export class BlueprintMarketplaceService {
  private readonly capability: BlueprintMarketplaceCapability = {
    id: 'blueprint-marketplace',
  ...
  getStatus(): BlueprintMarketplaceCapability {
    return {
      ...this.capability,
