...
import { SelfHealingEngineCapability } from './self-healing-engine.types';

@Injectable()
export class SelfHealingEngineService {
  private readonly capability: SelfHealingEngineCapability = {
  ...
  getStatus(): SelfHealingEngineCapability {
    return {
      ...this.capability,
