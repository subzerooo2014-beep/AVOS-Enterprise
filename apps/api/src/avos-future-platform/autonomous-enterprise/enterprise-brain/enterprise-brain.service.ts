...
import { EnterpriseBrainCapability } from './enterprise-brain.types';

@Injectable()
export class EnterpriseBrainService {
  private readonly capability: EnterpriseBrainCapability = {
    id: 'enterprise-brain',
  ...
  getStatus(): EnterpriseBrainCapability {
    return {
      ...this.capability,
