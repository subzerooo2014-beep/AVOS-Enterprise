...
import { InsurancePlatformCapability } from './insurance-platform.types';

@Injectable()
export class InsurancePlatformService {
  private readonly capability: InsurancePlatformCapability = {
  ...
  getStatus(): InsurancePlatformCapability {
    return {
      ...this.capability,
