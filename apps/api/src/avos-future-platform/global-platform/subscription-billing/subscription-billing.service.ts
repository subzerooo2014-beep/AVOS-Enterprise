...
import { SubscriptionBillingCapability } from './subscription-billing.types';

@Injectable()
export class SubscriptionBillingService {
  private readonly capability: SubscriptionBillingCapability = {
  ...
  getStatus(): SubscriptionBillingCapability {
    return {
      ...this.capability,
