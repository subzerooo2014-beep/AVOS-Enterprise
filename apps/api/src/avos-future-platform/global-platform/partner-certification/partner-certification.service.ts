...
import { PartnerCertificationCapability } from './partner-certification.types';

@Injectable()
export class PartnerCertificationService {
  private readonly capability: PartnerCertificationCapability = {
  ...
  getStatus(): PartnerCertificationCapability {
    return {
      ...this.capability,
