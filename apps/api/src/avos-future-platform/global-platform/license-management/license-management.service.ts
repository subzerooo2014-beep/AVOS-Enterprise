...
import { LicenseManagementCapability } from './license-management.types';

@Injectable()
export class LicenseManagementService {
  private readonly capability: LicenseManagementCapability = {
  ...
  getStatus(): LicenseManagementCapability {
    return {
      ...this.capability,
