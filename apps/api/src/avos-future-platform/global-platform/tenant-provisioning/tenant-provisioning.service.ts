...
import { TenantProvisioningCapability } from './tenant-provisioning.types';

@Injectable()
export class TenantProvisioningService {
  private readonly capability: TenantProvisioningCapability = {
  ...
  getStatus(): TenantProvisioningCapability {
    return {
      ...this.capability,
