...
import { GlobalOperationsCenterCapability } from './global-operations-center.types';

@Injectable()
export class GlobalOperationsCenterService {
  private readonly capability: GlobalOperationsCenterCapability = {
    id: 'global-operations-center',
    name: 'GlobalOperationsCenter',
  ...
  getStatus(): GlobalOperationsCenterCapability {
    return {
      ...this.capability,
