...
import { NotificationIntelligenceCapability } from './notification-intelligence.types';

@Injectable()
export class NotificationIntelligenceService {
  private readonly capability: NotificationIntelligenceCapability = {
  ...
  getStatus(): NotificationIntelligenceCapability {
    return {
      ...this.capability,
