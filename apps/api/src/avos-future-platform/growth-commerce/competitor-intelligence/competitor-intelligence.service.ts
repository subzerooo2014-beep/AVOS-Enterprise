...
import { CompetitorIntelligenceCapability } from './competitor-intelligence.types';

@Injectable()
export class CompetitorIntelligenceService {
  private readonly capability: CompetitorIntelligenceCapability = {
  ...
  getStatus(): CompetitorIntelligenceCapability {
    return {
      ...this.capability,
