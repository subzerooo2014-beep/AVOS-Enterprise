...
import { EnterpriseSandboxCapability } from './enterprise-sandbox.types';

@Injectable()
export class EnterpriseSandboxService {
  private readonly capability: EnterpriseSandboxCapability = {
  ...
  getStatus(): EnterpriseSandboxCapability {
    return {
      ...this.capability,
