...
import { OperationsCenterCapability } from './operations-center.types';

@Injectable()
export class OperationsCenterService {
  private readonly capability: OperationsCenterCapability = {
  ...
  getStatus(): OperationsCenterCapability {
    return {
      ...this.capability,
