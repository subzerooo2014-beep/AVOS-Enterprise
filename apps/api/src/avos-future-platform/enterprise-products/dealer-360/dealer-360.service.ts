...
import { Dealer360Capability } from './dealer-360.types';

@Injectable()
export class Dealer360Service {
  private readonly capability: Dealer360Capability = {
    id: 'dealer-360',
    name: 'Dealer360',
