...
import { ErpPlatformCapability } from './erp-platform.types';

@Injectable()
export class ErpPlatformService {
  private readonly capability: ErpPlatformCapability = {
    id: 'erp-platform',
    name: 'ErpPlatform',
  ...
  getStatus(): ErpPlatformCapability {
    return {
      ...this.capability,
