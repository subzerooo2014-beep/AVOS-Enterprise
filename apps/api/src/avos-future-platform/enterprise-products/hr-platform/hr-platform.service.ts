...
import { HrPlatformCapability } from './hr-platform.types';

@Injectable()
export class HrPlatformService {
  private readonly capability: HrPlatformCapability = {
    id: 'hr-platform',
    name: 'HrPlatform',
  ...
  getStatus(): HrPlatformCapability {
    return {
      ...this.capability,
