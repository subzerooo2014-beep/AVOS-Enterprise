...
import { FinancePlatformCapability } from './finance-platform.types';

@Injectable()
export class FinancePlatformService {
  private readonly capability: FinancePlatformCapability = {
    id: 'finance-platform',
  ...
  getStatus(): FinancePlatformCapability {
    return {
      ...this.capability,
