...
import { OperationalMemoryCapability } from './operational-memory.types';

@Injectable()
export class OperationalMemoryService {
  private readonly capability: OperationalMemoryCapability = {
  ...
  getStatus(): OperationalMemoryCapability {
    return {
      ...this.capability,
