...
import { SemanticIntelligenceCapability } from './semantic-intelligence.types';

@Injectable()
export class SemanticIntelligenceService {
  private readonly capability: SemanticIntelligenceCapability = {
  ...
  getStatus(): SemanticIntelligenceCapability {
    return {
      ...this.capability,
