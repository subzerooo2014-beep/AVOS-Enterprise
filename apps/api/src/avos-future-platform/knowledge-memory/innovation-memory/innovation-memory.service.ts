...
import { InnovationMemoryCapability } from './innovation-memory.types';

@Injectable()
export class InnovationMemoryService {
  private readonly capability: InnovationMemoryCapability = {
    id: 'innovation-memory',
    name: 'InnovationMemory',
  ...
  getStatus(): InnovationMemoryCapability {
    return {
      ...this.capability,
