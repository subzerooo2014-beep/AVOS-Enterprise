...
import { ArchitectureDriftDetectorCapability } from './architecture-drift-detector.types';

@Injectable()
export class ArchitectureDriftDetectorService {
  private readonly capability: ArchitectureDriftDetectorCapability = {
    id: 'architecture-drift-detector',
    name: 'ArchitectureDriftDetector',
  ...
  getStatus(): ArchitectureDriftDetectorCapability {
    return {
      ...this.capability,
