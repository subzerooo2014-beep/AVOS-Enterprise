...
import { DecisionTraceabilityCapability } from './decision-traceability.types';

@Injectable()
export class DecisionTraceabilityService {
  private readonly capability: DecisionTraceabilityCapability = {
  ...
  getStatus(): DecisionTraceabilityCapability {
    return {
      ...this.capability,
