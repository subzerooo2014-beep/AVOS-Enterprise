...
import { TrustScoreEngineCapability } from './trust-score-engine.types';

@Injectable()
export class TrustScoreEngineService {
  private readonly capability: TrustScoreEngineCapability = {
    id: 'trust-score-engine',
    name: 'TrustScoreEngine',
  ...
  getStatus(): TrustScoreEngineCapability {
    return {
      ...this.capability,
