...
import { DataGovernanceCenterCapability } from './data-governance-center.types';

@Injectable()
export class DataGovernanceCenterService {
  private readonly capability: DataGovernanceCenterCapability = {
  ...
  getStatus(): DataGovernanceCenterCapability {
    return {
      ...this.capability,
