...
import { PrescriptiveAnalyticsCapability } from './prescriptive-analytics.types';

@Injectable()
export class PrescriptiveAnalyticsService {
  private readonly capability: PrescriptiveAnalyticsCapability = {
  ...
  getStatus(): PrescriptiveAnalyticsCapability {
    return {
      ...this.capability,
