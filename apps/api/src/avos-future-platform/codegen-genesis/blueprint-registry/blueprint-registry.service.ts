...
import { BlueprintRegistryCapability } from './blueprint-registry.types';

@Injectable()
export class BlueprintRegistryService {
  private readonly capability: BlueprintRegistryCapability = {
    id: 'blueprint-registry',
  ...
  getStatus(): BlueprintRegistryCapability {
    return {
      ...this.capability,
