...
export class AviationIndustryController {
  ...
  createRecord(
    ...
    return this.industry.createRecord("AVIATION", capability, input);
  }
  ...
  listRecords(
    ...
    return this.industry.listRecords("AVIATION", capability, tenantId);
  }
  ...
  @Get("command-center")
  commandCenter() {
    return this.industry.commandCenter("AVIATION");
  }
}