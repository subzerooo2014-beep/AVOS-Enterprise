...
@Controller("maritime-industry")
export class MaritimeIndustryController {
  ...
  createRecord(
    ...
    return this.industry.createRecord("MARITIME", capability, input);
  }
  ...
  listRecords(
    ...
    return this.industry.listRecords("MARITIME", capability, tenantId);
  }
  ...
  @Get("command-center")
  commandCenter() {
    return this.industry.commandCenter("MARITIME");
  }
}