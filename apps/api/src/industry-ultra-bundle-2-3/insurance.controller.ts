...
@Controller("insurance-industry-platform")
export class InsuranceIndustryController {
  ...
  createRecord(
    ...
    return this.industry.createRecord("INSURANCE", capability, input);
  }
  ...
  listRecords(
    ...
    return this.industry.listRecords("INSURANCE", capability, tenantId);
  }
  ...
  @Get("command-center")
  commandCenter() {
    return this.industry.commandCenter("INSURANCE");
  }
}