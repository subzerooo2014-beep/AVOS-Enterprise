...
@Controller("hospitality-tourism-industry")
export class HospitalityTourismIndustryController {
  ...
  createRecord(
    ...
    return this.industry.createRecord("HOSPITALITY_TOURISM", capability, input);
  }
  ...
  listRecords(
    ...
    return this.industry.listRecords("HOSPITALITY_TOURISM", capability, tenantId);
  }
  ...
  @Get("command-center")
  commandCenter() {
    return this.industry.commandCenter("HOSPITALITY_TOURISM");
  }
}