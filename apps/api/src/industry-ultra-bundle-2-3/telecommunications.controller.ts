...
@Controller("telecommunications-industry")
export class TelecommunicationsIndustryController {
  ...
  createRecord(
    ...
    return this.industry.createRecord("TELECOMMUNICATIONS", capability, input);
  }
  ...
  listRecords(
    ...
    return this.industry.listRecords("TELECOMMUNICATIONS", capability, tenantId);
  }
  ...
  @Get("command-center")
  commandCenter() {
    return this.industry.commandCenter("TELECOMMUNICATIONS");
  }
}