...
@Controller("energy-utilities-industry")
export class EnergyUtilitiesIndustryController {
  ...
  createRecord(
    ...
    return this.industry.createRecord("ENERGY_UTILITIES", capability, input);
  }
  ...
  listRecords(
    ...
    return this.industry.listRecords("ENERGY_UTILITIES", capability, tenantId);
  }
  ...
  @Get("command-center")
  commandCenter() {
    return this.industry.commandCenter("ENERGY_UTILITIES");
  }
}