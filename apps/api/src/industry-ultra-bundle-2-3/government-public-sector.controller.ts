...
@Controller("government-public-sector-industry")
export class GovernmentPublicSectorIndustryController {
  ...
  createRecord(
    ...
    return this.industry.createRecord("GOVERNMENT_PUBLIC_SECTOR", capability, input);
  }
  ...
  listRecords(
    ...
    return this.industry.listRecords("GOVERNMENT_PUBLIC_SECTOR", capability, tenantId);
  }
  ...
  @Get("command-center")
  commandCenter() {
    return this.industry.commandCenter("GOVERNMENT_PUBLIC_SECTOR");
  }
}