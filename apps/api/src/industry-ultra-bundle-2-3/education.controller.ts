...
@Controller("education-industry")
export class EducationIndustryController {
  ...
  createRecord(
    ...
    return this.industry.createRecord("EDUCATION", capability, input);
  }
  ...
  listRecords(
    ...
    return this.industry.listRecords("EDUCATION", capability, tenantId);
  }
  ...
  @Get("command-center")
  commandCenter() {
    return this.industry.commandCenter("EDUCATION");
  }
}