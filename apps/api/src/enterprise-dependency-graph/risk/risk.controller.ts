...
import { DependencyRiskRecord } from "./risk.types";

@Controller("enterprise-dependency-graph/risk")
export class DependencyRiskController {
  constructor(private readonly service: DependencyRiskService) {}
  ...
  @Post("records") create(@Body() body: Pick<DependencyRiskRecord, "name" | "description"> & Partial<Pick<DependencyRiskRecord, "score" | "dependency">>) { return this.service.create(body); }
