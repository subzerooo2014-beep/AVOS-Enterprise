...
import { DependencyAnalyticsRecord } from "./analytics.types";

@Controller("enterprise-dependency-graph/analytics")
export class DependencyAnalyticsController {
  constructor(private readonly service: DependencyAnalyticsService) {}
  ...
  @Post("records") create(@Body() body: Pick<DependencyAnalyticsRecord, "name" | "description"> & Partial<Pick<DependencyAnalyticsRecord, "score" | "dependency">>) { return this.service.create(body); }
