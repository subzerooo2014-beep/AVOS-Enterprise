...
import { DependencyScannerRecord } from "./scanner.types";

@Controller("enterprise-dependency-graph/scanner")
export class DependencyScannerController {
  constructor(private readonly service: DependencyScannerService) {}
  ...
  @Post("records") create(@Body() body: Pick<DependencyScannerRecord, "name" | "description"> & Partial<Pick<DependencyScannerRecord, "score" | "dependency">>) { return this.service.create(body); }
