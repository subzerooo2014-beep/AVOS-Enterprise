export enum GovernanceEnvironment {
...
export enum GovernanceControlMode {
  OBSERVE = "observe",
  ADVISORY = "advisory",
  ENFORCE = "enforce",
  LOCKDOWN = "lockdown",
...
export enum GovernanceApprovalStatus {
  PENDING = "pending",
  APPROVED = "approved",
  REJECTED = "rejected",
  EXPIRED = "expired",
...
export enum GovernanceRecommendationType {
  APPROVE = "approve",
  REJECT = "reject",
  DEFER = "defer",
...
export enum DependencyHealthStatus {
  HEALTHY = "healthy",
  DEGRADED = "degraded",
  UNHEALTHY = "unhealthy",
...
export enum CascadingFailureRisk {
  NONE = "none",
  LOW = "low",
  MEDIUM = "medium",
  HIGH = "high",
...
export enum SloComplianceStatus {
  COMPLIANT = "compliant",
  AT_RISK = "at_risk",
  BREACHED = "breached",
  UNKNOWN = "unknown",
...
export enum GovernanceAuditEventType {
...
export enum GovernanceSimulationStatus {
  PENDING = "pending",
  RUNNING = "running",
  COMPLETED = "completed",
  FAILED = "failed",
...
export enum GovernanceImpactCategory {
  SERVICE = "service",
...
export enum GovernanceApprovalTier {
  NONE = "none",
  STANDARD = "standard",
  ELEVATED = "elevated",
  SENIOR = "senior",
...
export enum IsolationPlanStatus {
  DRAFT = "draft",
  READY = "ready",
  ACTIVE = "active",
  COMPLETED = "completed",
...
export enum CapacityMetricType {
  CPU = "cpu",
  MEMORY = "memory",
  DISK = "disk",
  NETWORK = "network",
...
export enum CapacityPolicyStatus {
  DRAFT = "draft",
  ACTIVE = "active",
  DISABLED = "disabled",
  ARCHIVED = "archived",
...
export enum CapacityEvaluationStatus {
  HEALTHY = "healthy",
  WARNING = "warning",
  CRITICAL = "critical",
  UNKNOWN = "unknown",
...
export enum RuntimeDecisionRecordStatus {
  DRAFT = "draft",
  GENERATED = "generated",
...
export enum RuntimeDecisionSource {
  POLICY = "policy",
...
export enum RuntimeDecisionConfidence {
  LOW = "low",
  MEDIUM = "medium",
  HIGH = "high",
  VERY_HIGH = "very_high",
...
export enum ApprovalSuggestionDecision {
...
export enum GuardrailEvaluationResult {
  PASSED = "passed",
  WARNING = "warning",
  FAILED = "failed",
  SKIPPED = "skipped",
...
export enum RuntimeRunbookStatus {
  DRAFT = "draft",
  ACTIVE = "active",
  DISABLED = "disabled",
  ARCHIVED = "archived",
...
export enum RuntimeRunbookStepType {
  VALIDATE = "validate",
  NOTIFY = "notify",
...
export enum RuntimeRunbookExecutionStatus {
  PENDING = "pending",
  RUNNING = "running",
  PAUSED = "paused",
  SUCCEEDED = "succeeded",
...
export enum RuntimeRunbookStepStatus {
  PENDING = "pending",
  RUNNING = "running",
  SUCCEEDED = "succeeded",
  FAILED = "failed",
...
export enum RuntimeChangeExecutionStatus {
  CREATED = "created",
...
export enum RuntimeExecutionEvidenceType {
...
export enum GovernanceScheduleStatus {
  DRAFT = "draft",
  ACTIVE = "active",
  PAUSED = "paused",
  COMPLETED = "completed",
...
export enum GovernanceScheduleType {
...
export enum GovernanceScheduleRunStatus {
  PENDING = "pending",
  RUNNING = "running",
  SUCCEEDED = "succeeded",
  FAILED = "failed",
...
export enum GovernanceEscalationStatus {
  OPEN = "open",
...
export enum GovernanceEscalationSeverity {
  INFORMATIONAL = "informational",
  WARNING = "warning",
  HIGH = "high",
  CRITICAL = "critical",
...
export enum GovernanceEscalationReason {
...
export enum GovernanceNotificationChannel {
  INTERNAL = "internal",
  EMAIL = "email",
  SMS = "sms",
  PUSH = "push",
...
export enum GovernanceNotificationStatus {
  PENDING = "pending",
  QUEUED = "queued",
  SENT = "sent",
  DELIVERED = "delivered",
...
export enum GovernanceTimelineEventType {
...
export enum GovernanceCheckpointStatus {
  CREATED = "created",
  VERIFIED = "verified",
  INVALID = "invalid",
...
export enum GovernanceCheckpointType {
  MANUAL = "manual",
...
export enum GovernanceSnapshotScope {
  FULL = "full",
...
export enum GovernanceRetentionStatus {
  DRAFT = "draft",
  ACTIVE = "active",
  DISABLED = "disabled",
  ARCHIVED = "archived",
...
export enum GovernanceRetentionAction {
  RETAIN = "retain",
  ARCHIVE = "archive",
  COMPRESS = "compress",
  REDACT = "redact",
...
export enum GovernanceArchiveStatus {
  PENDING = "pending",
  CREATING = "creating",
  READY = "ready",
  VERIFIED = "verified",
...
export enum GovernanceArchiveType {
...
export enum GovernanceRestoreStatus {
  DRAFT = "draft",
  VALIDATING = "validating",
  READY = "ready",
  BLOCKED = "blocked",
