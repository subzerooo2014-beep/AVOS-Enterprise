...
import { MemoryStorageRecord } from "./storage.types";

@Controller("memory-architecture/storage")
export class MemoryStorageController {
  constructor(private readonly service: MemoryStorageService) {}
  ...
  @Post("records") create(@Body() body: Pick<MemoryStorageRecord, "name" | "description"> & Partial<Pick<MemoryStorageRecord, "score" | "metadata">>) { return this.service.create(body); }
