...
$CommitMessage = "feat(api): core application flows v1 ultra bundle k mega packs 226-250"
...
$requiredFiles = @(
    "apps/api/src/core-application-flows/core-flow-change.types.ts",
    "apps/api/src/core-application-flows/core-flow-change.service.ts",
    "apps/api/src/core-application-flows/core-flow-impact.service.ts",
    "apps/api/src/core-application-flows/core-flow-release-gate.service.ts",
    "apps/api/src/core-application-flows/core-flow-rollback-plan.service.ts",
    "apps/api/src/core-application-flows/core-flow-change-governance.service.ts",
    "apps/api/src/core-application-flows/core-flow-change.controller.ts",
    "apps/api/scripts/verify-core-application-flows-v1-ultra-bundle-k-226-250.mjs",
    "apps/api/scripts/smoke-core-application-flows-v1-ultra-bundle-k-226-250.mjs",
    "apps/api/scripts/execute-core-application-flows-v1-ultra-bundle-k-226-250.ps1"
)
...
$module = Add-ModuleArrayEntry $module "controllers" "CoreFlowChangeController"
...
pnpm build
if ($LASTEXITCODE -ne 0) {
    throw "Core Application Flows Ultra Bundle K build failed."
}

$verificationJson = & node (Join-Path $ScriptRoot "verify-core-application-flows-v1-ultra-bundle-k-226-250.mjs")
if ($LASTEXITCODE -ne 0) {
    throw "Ultra Bundle K verification failed."
}
$verificationJson | ConvertFrom-Json | Format-List

$smokeJson = & node (Join-Path $ScriptRoot "smoke-core-application-flows-v1-ultra-bundle-k-226-250.mjs")
if ($LASTEXITCODE -ne 0) {
    throw "Ultra Bundle K smoke test failed."
}
...
Write-Host "Core Application Flows Ultra Bundle K Mega Packs 226-250 completed successfully." -ForegroundColor Green
