...
$CommitMessage = "feat(api): core application flows v2 ultra bundle o mega packs 326-350"
...
$requiredFiles = @(
    "apps/api/src/core-application-flows-v2/core-flow-worker.types.ts",
    "apps/api/src/core-application-flows-v2/core-flow-worker-store.service.ts",
    "apps/api/src/core-application-flows-v2/core-flow-worker-registry.service.ts",
    "apps/api/src/core-application-flows-v2/core-flow-durable-messaging.service.ts",
    "apps/api/src/core-application-flows-v2/core-flow-worker-runtime.service.ts",
    "apps/api/src/core-application-flows-v2/core-flow-worker.controller.ts",
    "apps/api/scripts/verify-core-application-flows-v2-ultra-bundle-o-326-350.mjs",
    "apps/api/scripts/smoke-core-application-flows-v2-ultra-bundle-o-326-350.mjs",
    "apps/api/scripts/execute-core-application-flows-v2-ultra-bundle-o-326-350.ps1"
)
...
$module = Add-ModuleArrayEntry $module "controllers" "CoreFlowWorkerController"
$providers = @(
...
pnpm build
if ($LASTEXITCODE -ne 0) { throw "Ultra Bundle O build failed." }

$verificationJson = & node (Join-Path $ScriptRoot "verify-core-application-flows-v2-ultra-bundle-o-326-350.mjs")
if ($LASTEXITCODE -ne 0) { throw "Ultra Bundle O verification failed." }
$verificationJson | ConvertFrom-Json | Format-List

$smokeJson = & node (Join-Path $ScriptRoot "smoke-core-application-flows-v2-ultra-bundle-o-326-350.mjs")
if ($LASTEXITCODE -ne 0) { throw "Ultra Bundle O smoke failed." }
...
Write-Host "Core Application Flows V2 Ultra Bundle O completed successfully." -ForegroundColor Green
